...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/nelodignaturut/neLua/main/UI/cav.lua"))()
...
Section:NewButton("sbor", "does things needed", function()
