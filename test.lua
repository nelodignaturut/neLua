...
Section:NewButton("Script for fishing and mining", "ONLY FOR MINING AND FISHING", function()
	loadstring(game:HttpGet"https://rawscripts.net/raw/FLOOR-14Sword-Blox-Online:-Rebirth-Sword-3551")()
	print("please wait for a moment to load")
end)
Section:NewButton("10 fish every 4 minutes", "Forced on function, rejoin to disable,", function()
do
    spawnloop(
        function()
...
Section:NewButton("inf stamina", "Forced on function, rejoin to disable,", function()
        do
            local Enabled
...
local Section = Tab:NewSection("AutoCollectSection")
Section:NewButton("collect material", "Forced on function, rejoin to disable,", function()
    do
